...
.. note::
   The device ID used in the connection towards Azure IoT Hub can provided run-time by setting the ``device_id`` member of the :c:struct:`azure_iot_hub_config` structure when calling :c:func:`azure_iot_hub_connect`.
