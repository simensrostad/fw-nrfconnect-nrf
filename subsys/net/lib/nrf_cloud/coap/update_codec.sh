...
zcbor -c cddl/nrf_cloud_coap_ground_fix.cddl --default-max-qty 10 code -e \
	-t ground_fix_req \
...
zcbor -c cddl/nrf_cloud_coap_ground_fix.cddl --default-max-qty 10 code -d \
	-t ground_fix_resp \
...
zcbor -c cddl/nrf_cloud_coap_device_msg.cddl --default-max-qty 10 code -e \
	-t message_out \
	--oc src/msg_encode.c \
...
zcbor -c cddl/nrf_cloud_coap_agps.cddl       --default-max-qty 10 code -e \
	-t agps_req \
...
zcbor -c cddl/nrf_cloud_coap_pgps.cddl       --default-max-qty 10 code -e \
	-t pgps_req \
...
zcbor -c cddl/nrf_cloud_coap_pgps.cddl       --default-max-qty 10 code -d \
	-t pgps_resp \
