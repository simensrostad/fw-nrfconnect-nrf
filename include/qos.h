...
/** @brief Structured received in library callback events. */
struct qos_evt {
 ...
 *
 *  @retval 0 on success.
 *  @retval -ENODATA If the passed in message ID is not found in the interal list.
 */
