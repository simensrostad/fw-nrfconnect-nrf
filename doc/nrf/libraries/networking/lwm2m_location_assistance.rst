...
The library adds support for four objects related to the location assistance.
...
* ECID-Signal Measurement Information object (ID 10256) for storing the cell neighborhood.
