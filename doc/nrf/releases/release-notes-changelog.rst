...
* :ref:`lib_nrf_cloud` library:
  ...
  * Updated:
    ...
    * Moved the :c:func:`nrf_cloud_location_request_json_get` function from the file :file:`nrf_cloud_location.h` to file :file:`nrf_cloud_codec.h`. The function is now named :c:func:`nrf_cloud_location_request_msg_json_encode`.
