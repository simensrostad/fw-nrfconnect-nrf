...
/** @brief Create object and resource instances for objects that does not have this setup already
 *	   via default objects in the LwM2M engine.
 *
...
/** @brief Setup dedicated buffers for resources that doesn't have storage set in the respective
 *	   LwM2M object source file.
 *
 *  @retval 0 If successful, otherwise a negative value indicating the reason of failure.
 */
 ...
 *	   This function will populate the GNSS assistance object (33625) with the A-GPS request.
 *
 ...
 *	   This function will populate the GNSS assistance object (33625) with the P-GPS request.
 *
